...
export const firebaseConfig = {
  ...
  messagingSenderId: fromEnvOrDefault('NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID', '716627719667'),
  appId: fromEnvOrDefault('NEXT_PUBLIC_FIREBASE_APP_ID', '1:716627719667:web:a828412396c68af35b8e86'),
