	...
	return (
		<Document>
			...
			<Page size="A4" style={styles.page}>
				...
				{/* SECTION 5: REASON FOR INITIATION */}
			...
			{baseline && (
				<Page size="A4" style={styles.page}>
					...
					<TwoColRow
						...
						value2={baseline.heartRate}
					/>
					<TwoColRow
						label1="Serum Creatinine"
						value1={baseline.serumCreatinine}
						label2="eGFR (mL/min)"
						value2={baseline.egfr}
					/>
						...
						<>
							...
							<View style={styles.choiceRow}>
								...
								<CheckboxItem
									...
									checked={!!baseline.counseling.hypoglycemiaAwareness}
								/>
								<CheckboxItem
									label="UTI/Genital Awareness"
									checked={!!baseline.counseling.utiGenitialInfectionAwareness}
								/>
			...
			{visitsToShow.map((visit, visitIdx) => (
				<Page key={visitIdx} size="A4" style={styles.page}>
					...
					<TwoColRow
						...
						label2="Heart Rate (bpm)"
						value2={visit.heartRate}
					/>
					<TwoColRow
						label1="Serum Creatinine"
						value1={visit.serumCreatinine}
						label2="eGFR (mL/min)"
						value2={visit.egfr}
					/>
					...
					{visit.glycemicResponse && (
						<>
							...
							<DataField label="Category" value={visit.glycemicResponse.category} />
					...
					{visit.outcomes && (
						<>
							...
							<DataField label="Weight Change" value={visit.outcomes.weightChange} />
							<DataField label="BP Control Achieved" value={visit.outcomes.bpControlAchieved} />
							<DataField label="Renal Outcome" value={visit.outcomes.renalOutcome} />
						</>
					)}
					...
					{visit.adherence && (
						<>
							...
							{!visit.adherence.patientContinuingTreatment && (
								<DataField label="Discontinuation Reason" value={visit.adherence.discontinuationReason} />
							)}
					...
					{visit.physicianAssessment && (
						<>
							...
							<DataField label="Overall Efficacy" value={visit.physicianAssessment.overallEfficacy} />
							<DataField label="Overall Tolerability" value={visit.physicianAssessment.overallTolerability} />
							<DataField label="Compliance Judgment" value={visit.physicianAssessment.complianceJudgment} />
							<DataField
			...
			{/* ========== FINAL PAGE: DATA PRIVACY & DECLARATION ========== */}
			<Page size="A4" style={styles.page}>
				<View
					style={{
						marginBottom: 10,
